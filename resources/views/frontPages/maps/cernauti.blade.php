...
@section("title", "Mersul Trenului Chișinău -> Cernăuți -> Chișinău")
...
<div class="wow fadeInLeft obj">
    <h3>Rutele de tren: Chișinău -> Cernăuți -> Chișinău</h3>
</div>
<br>
<div class="wow fadeIn trv">
    <div class="map-alls">
        ...
        <div class="txth2">
            <h2>Chișinău -> Cernăuți -> Chișinău</h2>
        </div>
    ...
    <div class="formular-abonament">
        <div class="all-log">
            ...
            <ul class="station-list">
                <li>
                    <span class="station">Lipcani</span>
                </li>
            </ul>
            <ul class="station-list">
                <li>
                    <span class="station">Cernăuți</span>
                </li>
            </ul>
        </div>
    </div>
...
<script src="{{ asset('Map.js/cernauti.js') }}"></script>
