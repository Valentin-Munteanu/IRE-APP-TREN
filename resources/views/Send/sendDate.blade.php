...
<body>
    <div class="sendDate">
        <div class="modal-send">
            ...
            <h2 id="success-text" class="hidden">Datele au fost trimise cu succes.<br>Vă rugăm să verificați e-mailul pentru a primi Abonamentul.<br>Dacă nu găsiți confirmarea în pagina principală,<br>verificați și folderul de spam.</h2>
