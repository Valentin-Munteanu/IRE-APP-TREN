document.addEventListener('DOMContentLoaded', function() {
    ...
    let point2 = [45.9248343, 28.6501249];
    let point3 = [45.4717762, 28.2026721];
    ...
    L.marker(point2).addTo(map).bindPopup("Taraclia")
    L.marker(point3).addTo(map).bindPopup('Giurgiulești')
