...
class PassagersVagon1Request extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'selectedSeats' => [
                'required',
                Rule::unique('passagers_vagon1s')->where(function ($query) {
                    return $query->where('biletes_id', $this->bilet_id)
                                 ->where('selectedSeats', $this->input('selectedSeats'));
                })->ignore($this->id),
            ]
        ];
    }
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'selectedSeats' => 'Locul selectat este deja ocupat.'
