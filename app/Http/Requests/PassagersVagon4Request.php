...
class PassagersVagon4Request extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'selectedSeats4' => [
                'required',
                Rule::unique('passagers_vagon4s')->where(function ($query) {
                    return $query->where('biletes_id', $this->bilet_id)
                                 ->where('selectedSeats4', $this->input('selectedSeats4'));
                })->ignore($this->id),
            ]
        ];
    }
    public function messages(): array
    {
        return [
            ...
            'selectedSeats4' => 'Locul selectat este deja ocupat.'
